...
public static class FileExtensions
{
    ...
    public static DocumentType GetDocumentType(this string fileName)
    {
        ...
        if (imageExtentions.Contains(extention)) return DocumentType.Image;
        else if (videoExtentions.Contains(extention)) return DocumentType.Video;
