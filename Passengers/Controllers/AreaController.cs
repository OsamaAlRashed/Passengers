...
namespace Passengers.Controllers
{
    ...
    public class AreaController : ControllerBase
    {
        ...
        public AreaController(IAreaRepository countryRepository)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Add(AreaDto dto) => await repository.Add(dto).ToJsonResultAsync();

        [HttpPost]
        public async Task<IActionResult> Update(AreaDto dto) => await repository.Update(dto).ToJsonResultAsync();
